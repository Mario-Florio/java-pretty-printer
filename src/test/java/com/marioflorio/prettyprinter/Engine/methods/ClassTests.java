...
public class ClassTests {
    ...
    void formatsCustomClassCorrectly() {
        ...
        String expected = "[class TestClass] {staticProp: 'Static prop', staticMethod: [Method: staticMethod]}";
    ...
    void formatsCustomClassCorrectly2() {
        ...
        String expected = "[class TestClass2] {staticProp2: 'Static prop', staticMethod2: [Method: staticMethod2]}";
