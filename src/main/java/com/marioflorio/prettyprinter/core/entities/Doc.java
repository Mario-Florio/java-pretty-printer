package com.marioflorio.prettyprinter.core.entities;

import java.util.List;

public sealed interface Doc
    permits Doc.Text, Doc.Wrapper, Doc.Concat, Doc.LineBreak, Doc.IndentBlock {
  ...
  interface Renderer {
    default String render(Doc docTree) {
      return docTree.render(this, 0);
    }
